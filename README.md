...
![System teaser](assets/teaser.png)
...
| --- | --- | --- |
| `IGGT_CKPT_PATH` | IGGT checkpoint file | `./checkpoints/iggt/IGGT_official.pth` |
| `IGGT_DEVICE` | IGGT device | `cuda:0` |
| `IGGT_IMAGE_SIZE` | IGGT resize as `WIDTHxHEIGHT` | `392x630` |
| `LSEG_CKPT_PATH` | LSeg checkpoint file | `./checkpoints/lseg/demo_e200.ckpt` |
